...
>;
const ServiceBookingOthers = (props: ServiceBookingScreenTypes) => {
      ...
      <ScrollView nestedScrollEnabled={true} stickyHeaderIndices={[0]}>
        ...
        <View style={styles.container}>
          ...
          <View style={styles.personalDetailsSection}>
            ...
            />
            <InputComponent
              image={require('../../../assests/Images/ServiceScreenImages/groups.png')}
...
export default ServiceBookingOthers;
