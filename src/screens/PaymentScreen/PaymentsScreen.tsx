...
import Item from '../../components/ListItemPayment';
      ...
      {isEmptyData ? (
        <>
          ...
          <ScrollView stickyHeaderIndices={[0]}>
            <Header onPress={() => navigation.goBack()} title="PAYMENTS" />
            <View style={styles.container}>
              <View>
                <Image
                  source={require('../../../assests/Images/paymentsScreenImages/Asset-30.png')}
                />
              </View>
                ...
                <FlatList
                  ...
                  renderItem={({item}) => (
                    <Item
                      ...
                      image={require('../../../assests/Images/paymentsScreenImages/shopping_cart.png')}
                    />
                  )}
        ...
        <View style={styles.nodatacontainer}>
          <View>
            <Image
              style={styles.image}
              source={require('../../../assests/Images/paymentsScreenImages/Group546.png')}
            />
          </View>
